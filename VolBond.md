...
2. We investigate the results when we take into account the shout option. We use the option to lock in the coupon rate when he is above 3%.
...
We also have some summary statistics. 
...
- At this moment I have 20,000 economic scenarios from Moody's Application. I could investigate the results of the Vol-Bond when I use the scenarios of the evolution of the 20Y swap rate. This could be interesting for our management as they take investment decision based on this underlying economic scenarios. 
